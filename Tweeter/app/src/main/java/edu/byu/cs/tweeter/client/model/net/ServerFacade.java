...
public class ServerFacade {
    ...
    private static final String SERVER_URL = "https://pymdbxkpf4.execute-api.us-west-2.amazonaws.com/dev";
    ...
    public LogoutReponse logout(LogoutRequest request, String urlPath)
            throws IOException, TweeterRemoteException {
        return clientCommunicator.doPost(urlPath, request, null, LogoutReponse.class);
    }
    ...
    public GetCountResponse getCount(GetCountRequest request, String urlPath)
            throws IOException, TweeterRemoteException {
