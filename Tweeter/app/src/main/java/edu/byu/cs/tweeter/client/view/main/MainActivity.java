...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainPresenter.MainView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter.showFollowing(selectedUser);
    ...
    @Override
    public void followButtonVisibility(boolean value) {
        if (value) {
    ...
    @Override
    public void setFollowButton(boolean following) {
        if (following) {
    ...
    @Override
    public void setPostToast(String message) {
